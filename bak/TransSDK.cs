...
namespace AlarmMapClient
{
    public class TransSDK
    {
        ...
        */
        ...
        public static extern int P_Client_Init(pfmessageCallBack callback, Int32 dwUser);
        ...
        //设置报警回调
        [DllImport("ClientSDK.dll")]
        public static extern int P_Client_SetAlarmCallBack(pAlarmMessageCallBack callback, Int32 dwUser);
