...
H264_DVR_API bool CALL_METHOD H264_DVR_StopRealPlay(long lRealHandle);
...
//开始本地录像
H264_DVR_API bool CALL_METHOD H264_DVR_StartLocalRecord(int lRealHandle,char*szSaveFileName,long type=0);
//关闭本地录像
H264_DVR_API bool CALL_METHOD H264_DVR_StopLocalRecord(int lRealHandle);
