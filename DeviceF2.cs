...
namespace AlarmMapClient
{
    public class DeviceF2
    {
        ...
        private static DeviceF2 instance;
        private DeviceF2() { }
        public static DeviceF2 Instance 
　　    { 
　　        get 
　　        {
              if (instance == null)
              {
                  instance = new DeviceF2();
...
　　    } 
        ...
        private void HConnect(int lLoginID, string pchDVRIP, int nDVRPort, uint dwUser)
        {
            ...
            int err = 0;
            lhwd = NetSDK.H264_DVR_Login(url, port, username, password, ref lpDeviceInfo, ref err);
        }
        ...
        public bool Login(string serverUrl, ushort serverPort, string userName, string pwd, ref NetSDK.LPH264_DVR_DEVICEINFO lpDeviceInfo)
        {
            bool ret = false;
            this.url = serverUrl;
        ...
        public Int32 Play(int channel, IntPtr handle, int stream)
        {
            ...
            Int32 m_iPlayhandle = NetSDK.H264_DVR_RealPlay(this.lhwd, ref playstru);
        ...
        public bool SendTransportData(byte[] data, int nBufLen)
        {
            IntPtr pBuffer;
